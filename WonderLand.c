...
int main_menu()
{
    ...
    do
    {
        ...
        printf("\n\n");
        printf("                                             (3)==> Request Booking Cancelation.");
        printf("\n\n");
...
total1:
    ...
    {
        printf("\n\n       ('.') Sorry, One person need to book 1 seats at a time.");
...
// Bus sit list
    ...
    if(w==1 && z==1 && pick==2) // AC_Day_C_Dhaka
    {
        ...
        while(!feof(file))
        {
            ...
            printf("\t%s",copy);
            m++;
            if(m==4 || m==8 || m== 12 || m==16 || m== 20 || m==24 || m== 28 || m==32 || m== 36 || m==40)
                printf("\n");
        }
        fclose(file);
    }
...
match:
    ...
    printf("\n\n                           Name: ");
    puts(fullname_detail);
    printf("\n                           Contact Number : %d. \t\t         Email Adress: %s.",number_detail,email_detail);
